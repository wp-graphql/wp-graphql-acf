...
![Show in GraphQL Setting for ACF Field Groups](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/field-group-show-in-graphql.png)
...
To replicate the same field group documented here you can [download the exported field group](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/download/field-group-export.zip) and [import it](https://support.advancedcustomfields.com/forums/topic/importing-exporting-acf-settings/) into your environment. 
...
![Location rule set to Post Type is equal to Post](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/location-rule-post-type-post.png)
...
![Text field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/text-field-input.png)
...
![Text field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/text-field-query.png)
...
![Text Area field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/text-area-field-input.png)
...
![Number field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/number-field-input.png)
...
![Number field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/number-field-query.png)
...
![Range field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/range-field-input.png)
...
![Range field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/range-field-query.png)
...
![Email field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/email-field-input.png)
...
![Email field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/email-field-query.png)
...
![Url field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/url-field-input.png)
...
![URL field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/url-field-query.png)
...
![Password field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/password-field-input.png)
...
![Password field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/password-field-query.png)
...
![Image field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/image-field-input.png)
...
![Image field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/image-field-query.png)
...
![File field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/file-field-input.png)
...
![File field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/file-field-query.png)
...
![WYSIWYG field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/wysiwyg-field-input.png)
...
![WYSIWYG field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/wysiwyg-field-query.png)
...
![oEmbed field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/oembed-field-input.png)
...
![oEmbed field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/oembed-field-query.png)
...
![Gallery field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/gallery-field-input.png)
...
![Gallery field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/gallery-field-query.png)
...
![Select field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/select-field-input.png)
...
![Select field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/select-field-query.png)
...
![Checkbox field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/checkbox-field-input.png)
...
![Checkbox field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/checkbox-field-query.png)
...
![Radio Button field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/radio-button-field-input.png)
...
![Radio Button field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/radio-button-field-query.png)
...
![Button Group field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/button-group-field-input.png)
...
![True/False field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/true-false-group-field-input.png)
...
![True/False field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/true-false-field-query.png)
...
![Link field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/link-group-field-input.png)
...
![Link field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/link-field-query.png)
...
![Post Object field Post Type Config](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/post-object-field-post-type-config.png)

Then the Union type for the field will allow `Post` and `Page` types to be returned, as seen in the Schema via GraphiQL:

![Post Object field Union Possible Types](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/post-object-field-possible-types.png)
...
![Post Object field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/post-object-field-input-post.png)
...
![Post Object field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/post-object-field-query-post.png)

If the input of the field was saved as a Page, instead of a Post, like so:

![Post Object field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/post-object-field-input-page.png)
...
![Post Object field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/post-object-field-query-page.png)
...
![Post Object field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/post-object-field-input-multi.png)
...
![Post Object field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/post-object-field-query-multi.png)
...
![Page Link field Post Type Config](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/page-link-field-post-type-config.png)

Then the Union type for the field will allow `Post` and `Page` types to be returned, as seen in the Schema via GraphiQL:

![Page Link field Union Possible Types](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/page-link-field-possible-types.png)
...
![Page Link field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/page-link-field-input-page.png)
...
![Page Link field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/link-field-query-page.png)

Here, we set the value to the "Hello World" Post:

![Page Link field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/page-link-field-input-post.png)
...
![Page Link field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/link-field-query-post.png)
...
![Relationship field Post Type Config](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/relationship-field-post-type-config.png)

Then the Union type for the field will allow `Post` and `Page` types to be returned, as seen in the Schema via GraphiQL:

![Relationship field Union Possible Types](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/relationship-field-possible-types.png)
...
![Relationship field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/relationship-field-input.png)
...
![Relationship field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/relationship-field-query.png)
...
![Taxonomy field Taxonomy Config](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/taxonomy-field-taxonomy-config.png)
...
![Taxonomy field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/taxonomy-field-input.png)
...
![Taxonomy field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/taxonomy-field-query.png)
...
![User field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/user-field-input.png)
...
![User field Query with one selection](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/user-field-query.png)

If the field is configured to allow multiple selections, it's added to the Schema as a List Of the User type.

Here, we have a User field named `user` on the Post Edit screen within the "ACF Docs" Field Group, set with the User "jasonbahl" as the value.

![User field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/user-field-input-multi.png)
...
```
![User field Query with multiple selections](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/user-field-query-multiple.png)
...
![Google Map field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/google-map-field-input.png)
...
![Google Map field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/google-map-field-query.png)
...
![Date Picker field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/date-picker-field-input.png)
...
![Date Picker field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/date-picker-field-query.png)
...
![Date Picker field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/date-time-picker-field-input.png)
...
![Date/Time Picker field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/date-time-picker-field-query.png)
...
![Time Picker field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/time-picker-field-input.png)
...
![Time Picker field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/time-picker-field-query.png)
...
![Color Picker field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/color-picker-field-input.png)
...
![Color Picker field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/color-picker-field-query.png)
...
![Group field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/group-field-input.png)
...
![Group field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/group-field-query.png)
...
![Repeater field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/repeater-field-input.png)
...
![Repeater field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/repeater-field-query.png)
...
![Flex Fields Schema Union Possible Types](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/flex-field-union-possible-types.png)
...
![Flex field in the Edit Post screen](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/flex-field-input.png)
...
![Flex field Query](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/flex-field-query.png)
...
![Flex field Query 2](https://github.com/wp-graphql/wp-graphql-acf/tree/master/docs/img/flex-field-query2.png)
