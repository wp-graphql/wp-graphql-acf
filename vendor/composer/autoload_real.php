...
class ComposerAutoloaderInit3fbb9843644ca7389b188c6353f475fc
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit3fbb9843644ca7389b188c6353f475fc::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire3fbb9843644ca7389b188c6353f475fc($fileIdentifier, $file);
        }
...
function composerRequire3fbb9843644ca7389b188c6353f475fc($fileIdentifier, $file)
{
